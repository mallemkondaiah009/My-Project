    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'Admin'), (2, 'EV Center'), (3, 'User')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ev_center', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.evcenter')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
